...
class Transformer_Model_LNS(nn.Module):
    ...
    def forward(self, input_ids, target):
        ...
        memory_mask = torch.zeros(seq_length, seq_length, device=input_ids.device)
        ...
        decoded_output = self.decoder(tgt_input, encode_thought, tgt_mask=tgt_mask, memory_mask=memory_mask)
...
class ReasoningModelGUI:
    ...
    def create_widgets(self):
        ...
        self.architecture = tk.StringVar(value="Reasoning Model LNS")
