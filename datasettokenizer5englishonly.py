...
def build_tokenizer_from_dataset(dataset_dir, output_path, vocab_size=200000, use_bytelevel=True, lowercase=True, max_samples=100000):
    ...
    if use_bytelevel:
        ...
        trainer = trainers.BpeTrainer(
            ...
            end_of_word_suffix="",
            initial_alphabet=list("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~")  # Lock English chars and punctuation
        )
    else:
...
# Example usage:
dataset_dir = r"/home/austin/Sky-T1_data_17k"
